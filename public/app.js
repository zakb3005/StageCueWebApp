Vue.createApp({
    ...
    methods: {
        ...
        updateUserBio() {
            ...
            fetch("http://localhost:8080/users/bio", {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
        ...
        uploadProfilePic(event) {
            ...
            fetch("http://localhost:8080/users/profile-pic", {
                method: "POST",
                credentials: "include",
                body: formData
            })
        ...
        updateStory() {
            ...
            const url = `http://localhost:8080/stories/${this.editStory._id}`;
        ...
        uploadStoryThumbnail(event) {
            ...
            fetch(`http://localhost:8080/stories/${this.editStory._id}/thumbnail`, {
                method: "PUT",
                credentials: "include",
                body: formData
            })
        ...
        uploadPageImage(event) {
            ...
            fetch(`http://localhost:8080/stories/${this.editStory._id}/pages`, {
                method: "POST",
                credentials: "include",
                body: formData
            })
        ...
        fetchStories() {
            fetch("http://localhost:8080/stories", { credentials: "include" })
            .then(res => res.ok ? res.json() : Promise.reject(res))
            .then(data => {
        ...
        fetchStoryDetails() {
            fetch(`http://localhost:8080/stories/${this.storyId}`, { credentials: "include" })
            .then(res => res.ok ? res.json() : Promise.reject(res))
            .then(data => {
                this.story = data;
                this.setUserRating();
        ...
        fetchTopStories() {
            fetch("http://localhost:8080/stories/top", { credentials: "include" })
            .then(res => res.ok ? res.json() : Promise.reject(res))
            .then(data => {
        ...
        submitRating() {
            ...
            fetch(`http://localhost:8080/stories/${this.viewStory._id}/rate`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                credentials: "include",
        ...
        fetchUserStories() {
            ...
            fetch(`http://localhost:8080/users/${this.visitingUser._id}/stories`, { credentials: "include" })
            .then(res => res.ok ? res.json() : Promise.reject(res))
            .then(stories => {
        ...
        increaseViews() {
            fetch(`http://localhost:8080/stories/${this.viewStory._id}/viewCount`, {
                method: "PUT",
                credentials: "include"
            })
            .then(res => res.ok ? res.json() : Promise.reject(res))
        ...
        deleteStory() {
            ...
            fetch(`http://localhost:8080/stories/${this.editStory._id}`, {
                method: "DELETE",
                credentials: "include"
            })
